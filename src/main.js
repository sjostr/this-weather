...
System.register("app/app.module", ["@angular/platform-browser", "@angular/core", "@angular/http", "app/app.component", "@angular/forms"], function (exports_3, context_3) {
    "use strict";
    var __moduleName = context_3 && context_3.id;
    var platform_browser_1, core_2, http_1, app_component_1, forms_1, AppModule;
    return {
        setters: [
...
System.register("main", ["@angular/core", "@angular/platform-browser-dynamic", "app/app.module", "environments/environment"], function (exports_4, context_4) {
    ...
    var core_3, platform_browser_dynamic_1, app_module_1, environment_2;
    return {
        setters: [
            function (core_3_1) {
                core_3 = core_3_1;
        ...
        execute: function () {
            if (environment_2.environment.production) {
